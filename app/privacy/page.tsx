...
export const metadata = { title: 'Privacy Policy – proflive.app' }
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="bg-white/[0.04] rounded-3xl shadow-2xl border border-white/10 p-8 md:p-12">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs font-semibold text-emerald-400 uppercase tracking-wide">Privacy Policy</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white mt-3">Informativa sulla Privacy</h1>
          ...
          <div className="prose prose-invert max-w-none mt-8 text-sm leading-relaxed space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-300">
                Il titolare del trattamento dei dati personali è <strong>proflive.app</strong>, raggiungibile all'indirizzo email{' '}
                <a href="mailto:astramentis.ltd.ad@gmail.com" className="text-emerald-400 hover:underline">astramentis.ltd.ad@gmail.com</a>.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-white mb-3">2. Dati raccolti</h2>
              <p className="text-gray-300 mb-3">Raccogliamo le seguenti categorie di dati personali:</p>
              <ul className="space-y-2 text-gray-300">
                {[
                  ...
                  <li key={item.title} className="flex gap-2">
                    ...
                    <span><strong className="text-gray-200">{item.title}:</strong> {item.desc}</span>
                  </li>
                ))}
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">3. Finalità e basi giuridiche del trattamento</h2>
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.base} className="bg-white/5 rounded-2xl p-4">
                    <p className="font-semibold text-gray-200 text-xs uppercase tracking-wide">{item.base}</p>
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">4. Conservazione dei dati</h2>
              <p className="text-gray-300">
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">5. Destinatari dei dati</h2>
              <p className="text-gray-300 mb-3">I tuoi dati possono essere condivisi con:</p>
              ...
              <p className="text-gray-300 mt-3">Non vendiamo, affittiamo o cediamo i dati a terzi per scopi commerciali.</p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-white mb-3">6. I tuoi diritti (GDPR)</h2>
              <p className="text-gray-300 mb-3">Ai sensi del Regolamento UE 2016/679 hai diritto a:</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  ...
                  <div key={right} className="flex items-start gap-2 text-gray-300">
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">7. Sicurezza</h2>
              <p className="text-gray-300">
            ...
            <section>
              <h2 className="text-lg font-bold text-white mb-3">8. Modifiche alla presente informativa</h2>
              <p className="text-gray-300">
